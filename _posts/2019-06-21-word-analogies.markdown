...
There have been surprisingly few theories trying to explain this phenomenon. Those that do exist, including the latent variable model ([Arora et al., 2016](https://arxiv.org/abs/1502.03520)) and the paraphrase model ([Gittens et al., 2017](https://www.aclweb.org/anthology/P17-1007); [Allen and Hospedales, 2019](https://arxiv.org/pdf/1901.09813.pdf)) make strong and untenable assumptions about the embedding space or distribution of word frequencies. There is no empirical evidence to support these theories either.
